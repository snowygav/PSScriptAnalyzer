            ...
            foreach (ILogger logger in ScriptAnalyzer.Instance.Loggers)
            {
                ...
                if (ReportSummary.IsPresent)
                {
                    ...
                    else
                    {
                        ...
                        var message = $"{numberOfRuleViolations} rule violation{pluralS} found.    Severity distribution:  {DiagnosticSeverity.Critical} = {errorCount}, {DiagnosticSeverity.Unknown} = {warningCount}, {DiagnosticSeverity.Information} = {infoCount}";
